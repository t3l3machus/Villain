...
## Table of contents
1. [Generate Reverse Shell Commands](#Generate-Reverse-Shell-Commands)
2. [Connect With Sibling Server](#Connect-With-Sibling-Server)
3. [Shell](#shell)
4. [Upload Command](#upload)
5. [Conptyshell](#Conptyshell)
6. [Exec](#Exec)
7. [Flee](#Flee)
8. [Purge](#Purge)
9. [Chat with Sibling Servers](#Chat-with-Sibling-Servers)
10. [Session Defender](#Session-Defender)
